...
<div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
	...
	<div class="p-4 space-y-3">
		...
		<button
			...
			class="w-full px-3 py-2 bg-[#801e32] text-white text-xs sm:text-sm font-medium rounded-lg hover:bg-[#6a1929] focus:ring-2 focus:ring-[#801e32] focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md"
		>
			📤 Upload billeder her
		</button>
	</div>
